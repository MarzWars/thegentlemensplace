        ...
        <tr>
          <td style="padding:36px 40px;">
            <h1 style="font-family:Georgia,serif; font-size:22px; color:#f0e8d0; margin:0 0 16px;">
              Your Private Connection Link
            </h1>
            <p style="font-size:15px; color:#c4b896; line-height:1.7; margin:0 0 24px;">
              Hello <strong><?= htmlspecialchars($name) ?></strong>,<br><br>
              Your private connection link to <strong><?= htmlspecialchars($performerName) ?></strong>
              is ready. This link expires in <strong><?= (int)$expMins ?> minutes</strong> and can only be used once.
            </p>
