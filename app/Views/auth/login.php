<div class="auth-page">
  <div class="auth-card">
    ...
    <?php elseif ($msg === 'dev_auto_verified'): ?>
      <div class="form-alert form-alert-success" role="alert">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
        <strong>Dev mode:</strong> Account auto-verified (no SMTP configured). Sign in below.
      </div>
    ...
    <form class="auth-form" method="POST" action="<?= BASE_PATH ?>/login" novalidate id="login-form">
      <?= \App\Core\CSRF::field() ?>
      ...
      <div class="form-group">
        <div class="form-label-row">
          ...
          <a href="<?= BASE_PATH ?>/forgot-password" class="form-label-link">Forgot password?</a>
        </div>
        <div class="input-wrap">
      ...
      <button type="submit" class="btn-primary btn-block btn-submit" id="login-submit">
    ...
    <div class="auth-card-footer">
      <p>Don't have an account? <a href="<?= BASE_PATH ?>/register">Create one — it's free</a></p>
    </div>
