<div class="admin-auth-page">
  <div class="admin-auth-card">
    ...
    <form class="auth-form" method="POST" action="<?= BASE_PATH ?>/admin/login" novalidate>
      <?= \App\Core\CSRF::field() ?>
      ...
      <div class="form-group">
        ...
        <div class="input-wrap">
          ...
          <input type="email" id="email" name="email" class="form-input"
                 placeholder="admin@thegentlemensplace.eu"
      ...
      <button type="submit" class="btn-primary btn-block btn-submit" style="margin-top:.5rem;">
        <span class="btn-text">Sign In to Admin</span>
        <span class="btn-spinner" aria-hidden="true"></span>
      </button>
    </form>

    <p style="text-align:center; margin-top:1.5rem; font-size:.65rem; color:rgba(196,184,150,.25); letter-spacing:.1em;">
